...
select round(12.3456, 1) from dual; -- 12.35
...
insert into member(id, member_email, member_password) values(1, 'aa@aa.com', '1234');
-- 모든 컬럼에 값을 다 넣을 때는 컬럼이름 생략 가능
insert into member1 values(2, 'bb@bb.com', '1234');
-- 특정 컬럼만 값을 넣을 때는
insert into member1 values(3, 'cc@cc.com');
insert into memeber1(id, member_email) values(3, 'cc@cc.com');
select * from member1;
...
-- id를 제외하고 나머지 값만 입력
insert into member2(member_email, member_password) values(1, 'bb@bb.com', '1234');
...
insert into member2(id, member_email, member_password) values(1, 'aa@aa.com', '1234');
insert into member2(id, member_email, member_password) values(1, 'bb@bb.com', '1234');
insert into member2(id, member_email, member_password) values(2, 'bb@bb.com', null);
...
insert into member6(id, member_email, member_password) 	values(1,'aa@aa.con' '1234');
insert into member6(id, member_email, member_password) 	values(2,'bb@bb.con' '1234');
...
insert into member8(id, member_email, member_password) 	values('aa@aa.con' '1234');
insert into member8(id, member_email, member_password) 	values('bb@bb.con' '1234');
...
create table child2(
    ...
    p_id bigint, -- 참조할 컬럼
    -- 외래키 지정(p_id 컬럼을 parent1 테이블의 id 컬럼을 참조하도록 함)
    -- 부모데이터 삭제 시 자식데이터도 삭제 (on delete cascade)
    constraint fk_child2 foreign key(p_id) references parent2(id) 
);
